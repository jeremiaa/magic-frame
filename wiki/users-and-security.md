...
now answers **HTTP 503 with a plain-text explanation** for `/login`, `/editor`
and the admin routes, and serves nothing behind them.
...
**If you see that 503**, or if `Settings → Security` says the session secret is
*weak*:
